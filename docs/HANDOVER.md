# family-comp-manager — Handover

**Repo:** [github.com/PaddyGallivan/family-comp-manager](https://github.com/PaddyGallivan/family-comp-manager)
...
## What this is
CF Worker family-comp-manager — deploys via GH Actions. NO LOCAL INFRA.
